...
(X_train_raw, y_train), (X_test_raw, y_test), encoder = load_data('data/bigger_categorise_data.json')
...
for data_name, (X_train, X_test, y_train) in datasets.items():
...
with open("experiments/bigger_data__SMOTE_baseline.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(output))
